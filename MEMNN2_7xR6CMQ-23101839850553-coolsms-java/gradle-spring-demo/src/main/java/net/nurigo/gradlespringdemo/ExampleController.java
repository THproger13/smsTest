...
public class ExampleController {
    ...
    public ExampleController() {
        ...
        this.messageService = NurigoApp.INSTANCE.initialize("NCSGYUYPMCBURYWS", "PMLISVFX12TRF8GE2AREJ0OXHVECY7QR", "https://api.coolsms.co.kr");
    }
...
//    }
    ...
    public ResponseEntity<String> sendOne() {
        ...
        message.setFrom("01088657126");
        message.setTo("01088657126");
        message.setText("좆우님의 핸드폰이 운지하였습니다! ㅅㄱ");
